...
# For Mistral Model
MODEL_NAME=intern_pm_0508_v2_hard10
TIME=20240509100919
RESULT_DIR=/fs-computility/llm/shared/wangyikun/dump/ad_preference_0508/ad_preference_0508_v2_hard_10k
...
CUDA_VISIBLE_DEVICES=2 python ${CODEBASE}/run.py evaluate \
