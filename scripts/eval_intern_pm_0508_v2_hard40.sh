...
# For Mistral Model
MODEL_NAME=intern_pm_0508_v2_hard40
TIME=20240509095612
RESULT_DIR=/fs-computility/llm/shared/wangyikun/dump/ad_preference_0508/ad_preference_0508_v2_hard_40k
...
CUDA_VISIBLE_DEVICES=4 python ${CODEBASE}/run.py evaluate \
